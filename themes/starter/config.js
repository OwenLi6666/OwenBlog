...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_1_URL:
    'https://docs.owenpower.com/article/vercel-deploy-notion-next', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '在Github上关注', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://github.com/OwenLi6666/OwenBlog', // 英雄区按钮
  ...
  STARTER_ABOUT_BUTTON_URL: 'https://docs.owenpower.com/about',
  ...
  STARTER_FAQ_1_ANSWER:
    'NotionNext提供了<a href="https://docs.owenpower.com/about" className="underline">帮助文档</a>，操作<a href="https://www.bilibili.com/video/BV1fM4y1L7Qi/" className="underline">演示视频</a>，以及<a href="https://docs.owenpower.com/article/chat-community" className="underline">交流社群</a>来协助您完成网站的搭建部署',

  STARTER_FAQ_2_QUESTION: '部署后要如何编写文章？',
  STARTER_FAQ_2_ANSWER:
    '您可以在Notion中之间添加或修改类型为Post的页面，内容将被实时同步在站点中，详情参考<a className="underline" href="https://docs.owenpower.com/article/start-to-write">《帮助文档》</a>',
  ...
  STARTER_TEAM_TEXT_2:
    'NotionNext 由众多开源技术爱好者们共同合作完成，感谢每一位<a className="underline" href="https://github.com/OwenLi6666/OwenBlog/graphs/contributors">贡献者</a>',
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'mail@owenpower.com',
  ...
  STARTER_FOOTER_LINK_GROUP: [
    {
      ...
      LINK_GROUP: [
        { TITLE: '官方主页', URL: '/#home' },
        { TITLE: '操作文档', URL: 'https://docs.owenpower.com/about' },
        {
          TITLE: '帮助支持',
          URL: 'https://docs.owenpower.com/article/how-to-question'
        },
        {
          TITLE: '合作申请',
          URL: 'https://docs.owenpower.com/article/my-service'
        }
      ]
    },
    {
      ...
      LINK_GROUP: [
        {
          TITLE: '部署指南',
          URL: 'https://docs.owenpower.com/article/vercel-deploy-notion-next'
        },
        {
          TITLE: '升级指南',
          URL: 'https://docs.owenpower.com/article/how-to-update-notionnext'
        },
        { TITLE: '最新版本', URL: 'https://docs.owenpower.com/article/latest' }
      ]
    },
    {
      TITLE: 'Notion写作',
      LINK_GROUP: [
        {
          TITLE: 'Notion开始写作',
          URL: 'https://docs.owenpower.com/article/start-to-write'
        },
        {
          TITLE: '快捷键提升效率',
          URL: 'https://docs.owenpower.com/article/notion-short-key'
        },
        {
          TITLE: '中国大陆使用Notion',
          URL: 'https://docs.owenpower.com/article/notion-faster'
        }
      ]
    }
  ],
  ...
  STARTER_CTA_BUTTON_URL:
    'https://docs.owenpower.com/article/vercel-deploy-notion-next',
  STARTER_CTA_BUTTON_TEXT: '开始体验',

  STARTER_POST_REDIRECT_ENABLE: true, // 默認開啟重定向
  STARTER_POST_REDIRECT_URL: 'https://blog.owenpower.com', // 重定向域名
  STARTER_NEWSLETTER: process.env.NEXT_PUBLIC_THEME_STARTER_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.owenpower.com/article/notion-next-mailchimp
}
