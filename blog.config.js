...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Building. Learning. Testing., Turning ideas into reality, Continuous learner, hands-on problem solver, Welcome to my digital lab 🔬',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Long Li (DragonLL)', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Lifelong learner & hands-on builder | QA Engineer in Abu Dhabi 🚀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dragonll.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'QA Engineering, Software Testing, Tech Blog, Mobile Testing, Automation, Long Li', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'longlidragon@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/longli_dragon', // 你的twitter个人主页
  ...
  // UUID重定向配置
  UUID_REDIRECT: process.env.NEXT_PUBLIC_UUID_REDIRECT || false, // 是否启用UUID重定向功能
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || '', // 你的代码仓库名， 例如我是 'OwenLi6666/OwenBlog'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || '', // 你的Github仓库名 e.g 'OwenLi6666/OwenBlog'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'DragonLL - Tech & QA Engineering Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Long Li\'s personal blog about QA Engineering, Software Testing, and Tech Insights. Based in Abu Dhabi, sharing experiences in mobile testing, automation, and software quality.', // 站点描述，被notion中的页面描述覆盖
