...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi, I\'m a QA Engineer, Hi, I\'m a Tech Enthusiast, Hi, I\'m a Problem Solver, Welcome to my digital space 🚀',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Long Li (DragonLL)', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'QA Engineer | Tech Explorer | Based in Abu Dhabi 🌍', // 作者简介
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2017weiliaowo@gmail.com', // 邮箱地址 例如mail@tangly1024.com
